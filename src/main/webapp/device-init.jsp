<%--
This is the page the user lands on when authenticating for the device flow. Feel free to
customize it.
...
<html>
<head>
    <title>OA4MP Example Device Flow Authentication Page</title>
    <link rel="stylesheet"
          type="text/css"
          media="all"
...
<br clear="all"/>
<div class="main">
    <h2>Welcome to the OA4MP example device flow authentication page.</h2>
    <p>You will need to do your logon plus (possibly) supply the user code that was given to you
